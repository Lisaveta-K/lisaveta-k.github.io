...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.position'
        db.add_column(u'shops_shop', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Shop.mart'
        db.alter_column(u'shops_shop', 'mart', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Shop.position'
        db.delete_column(u'shops_shop', 'position')


        # Changing field 'Shop.mart'
        db.alter_column(u'shops_shop', 'mart', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100))
