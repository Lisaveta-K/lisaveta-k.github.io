...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.mart'
        db.add_column(u'shops_shop', 'mart',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shop.mart'
        db.delete_column(u'shops_shop', 'mart')
    ...
    models = {
        ...
        u'shops.shop': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mart': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
