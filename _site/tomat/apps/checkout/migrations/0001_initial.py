...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'checkout_orderitem', (
            ...
            ('per_item', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
        ))
        ...
        db.create_table(u'checkout_order', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders', null=True, to=orm['users.User'])),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders', null=True, to=orm['users.Address'])),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders', null=True, to=orm['shops.Shop'])),
            ('status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('net', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('delivery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shops.Delivery'], null=True, blank=True)),
            ('delivery_cost', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('payment_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
    ...
    models = {
        u'checkout.order': {
            ...
            'net': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
