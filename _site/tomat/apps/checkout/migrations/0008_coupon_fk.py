...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'checkout_order', 'coupon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adverts.Coupon'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.coupon'
        db.delete_column(u'checkout_order', 'coupon_id')
