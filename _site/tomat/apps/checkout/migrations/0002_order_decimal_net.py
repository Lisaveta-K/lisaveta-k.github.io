...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.net'
        db.alter_column(u'checkout_order', 'net', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Order.net'
        db.alter_column(u'checkout_order', 'net', self.gf('django.db.models.fields.PositiveIntegerField')())
