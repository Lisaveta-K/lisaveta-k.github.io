...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'checkout_order', 'delivery_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shops.TransportCompany'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.delivery_company'
        db.delete_column(u'checkout_order', 'delivery_company_id')
    ...
    models = {
        u'checkout.order': {
            ...
            'delivery_company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shops.TransportCompany']", 'null': 'True', 'blank': 'True'}),
