...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.is_emails_sended'
        db.add_column(u'checkout_order', 'is_emails_sended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        orm['checkout.Order'].objects.all().update(is_emails_sended=True)


    def backwards(self, orm):
        # Deleting field 'Order.is_emails_sended'
        db.delete_column(u'checkout_order', 'is_emails_sended')
