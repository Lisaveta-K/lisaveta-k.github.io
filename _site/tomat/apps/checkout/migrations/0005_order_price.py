...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.products_price'
        db.add_column(u'checkout_order', 'products_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.products_price'
        db.delete_column(u'checkout_order', 'products_price')
