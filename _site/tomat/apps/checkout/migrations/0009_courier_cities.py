...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourierCity'
        db.create_table(u'checkout_couriercity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('price', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'checkout', ['CourierCity'])


    def backwards(self, orm):
        # Deleting model 'CourierCity'
        db.delete_table(u'checkout_couriercity')
