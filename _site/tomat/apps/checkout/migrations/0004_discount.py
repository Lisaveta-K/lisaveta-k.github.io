...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'checkout_order', 'discount',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shops.Discount'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.discount'
        db.delete_column(u'checkout_order', 'discount_id')
