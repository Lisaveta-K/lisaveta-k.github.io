...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ideas_categories', (
        ...
        db.create_table('ideas_idea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ideas.Category'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.create_table('ideas_idea_products', (
        ...
        db.create_unique('ideas_idea_products', ['idea_id', 'product_id'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('ideas_categories')

        # Deleting model 'Idea'
        db.delete_table('ideas_idea')

        # Removing M2M table for field products on 'Idea'
        db.delete_table('ideas_idea_products')
