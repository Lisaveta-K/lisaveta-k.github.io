...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('products_items', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Product.quantity'
        db.alter_column('products_items', 'quantity', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
