...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.wholesale_quantity'
        db.add_column('products_items', 'wholesale_quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.wholesale_quantity'
        db.delete_column('products_items', 'wholesale_quantity')
