...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.is_signable'
        db.add_column('products_categories', 'is_signable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.is_signable'
        db.delete_column('products_categories', 'is_signable')
