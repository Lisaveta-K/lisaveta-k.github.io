...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.complementary_hover_cover'
        db.add_column('products_categories', 'complementary_hover_cover',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.complementary_hover_cover'
        db.delete_column('products_categories', 'complementary_hover_cover')
