...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.is_visible'
        db.add_column('products_categories', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.is_visible'
        db.delete_column('products_categories', 'is_visible')
