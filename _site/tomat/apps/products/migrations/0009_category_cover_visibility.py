...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.show_cover_in_menu'
        db.add_column('products_categories', 'show_cover_in_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.show_cover_in_menu'
        db.delete_column('products_categories', 'show_cover_in_menu')
