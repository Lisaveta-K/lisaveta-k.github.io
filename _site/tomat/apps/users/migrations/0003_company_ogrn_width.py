...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.ogrn'
        db.alter_column(u'users_company', 'ogrn', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Company.ogrn'
        db.alter_column(u'users_company', 'ogrn', self.gf('django.db.models.fields.CharField')(max_length=13))
