...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.courier_city'
        db.add_column(u'users_address', 'courier_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checkout.CourierCity'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.courier_city'
        db.delete_column(u'users_address', 'courier_city_id')
